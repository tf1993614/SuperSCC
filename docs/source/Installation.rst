...
Since the `get_gene_module` function was written in R, you also need install `**geneModule** <https://github.com/tf1993614/SuperSCC/blob/main/geneModule/geneModule_0.0.0.9000.tar.gz>`_ R package::
