...
write.csv(F_module_rename, "F_module_orig2recode_name.csv")
...
write.csv(M_module_rename, "M_module_orig2recode_name.csv")
...
# sankey_df = sankey_df %>% dplyr::select(2:4, 7:10)
# sankey_df = sankey_df %>% dplyr::select(1:2, 5, 4, 7, 6)
# sankey_df = sankey_df %>% dplyr::select(1:4)
# 
# write.csv(sankey_df, "sankey_df2.csv")
