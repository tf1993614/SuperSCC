...
setwd("/home/fengtang/jupyter_notebooks/working_script/evulate_feature_selection/4th_submission/")

# read score files

top20_gpt5_files = list.files(pattern = "^top20_markers_gpt_5.+", 
                              path = "/home/fengtang/jupyter_notebooks/working_script/evulate_feature_selection/4th_submission",
                              recursive = F)

top10_gpt5_files = list.files(pattern = "top10_markers_gpt5_temp_five_tenth", 
                              path = "/home/fengtang/jupyter_notebooks/working_script/evulate_feature_selection/4th_submission/",
                              recursive = F,
                              full.names = T)


# input for one of top20_gpt5_files and top10_gpt5_files

all_files = top20_gpt5_files
# all_files = top10_gpt5_files
